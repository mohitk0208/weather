...
const DailyWeather = ({ weather, day, unit }) => {
  return (
    <div className="grid grid-cols-12 grid-rows-2 md:grid-cols-5 md:grid-rows-1 text-center justify-evenly items-center backdrop-blur-sm border border-white/20 rounded-md bg-black/[0.03] px-3 py-1">
      ...
      <div className="col-start-1 col-end-2 sm:col-end-3 text-lg md:text-base md:col-start-3 md:col-end-4 h-10">
        <img
      ...
      <div className="col-start-2 sm:col-start-3 col-end-7 text-sm md:text-base md:col-start-4 md:col-end-5 ">{weather.weather[0].main}</div>
      <div className="col-start-7 col-end-13 text-sm text-right md:text-center md:text-base md:col-start-5 md:col-end-6">
